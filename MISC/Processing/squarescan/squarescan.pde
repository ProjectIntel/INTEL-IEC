...
PrintWriter output;           // import serial library
...
for (int i = 0; i < 180; i=i+60) {     // for each degree in the array
...
strokeWeight(1);
stroke(0, 255-(30*i), 0);
rect(radius, radius, (500), (600)); 
line(i*86,50,i*86,350);
line(100,i*54,600,i*54);
fill(0, 100, 0);
noStroke();
...
fill(0, 100, 0);
int x1=int (value * cos(0.017*degree));
int y1= int (value * sin(0.017*degree));
output.println(x + " " + y);
...
text("X-Coordinate: "+Float.toString(x1),200,400,100,100);
text("Y-Coordinate: "+Float.toString(y1),200,440,100,100);
fill(0);
rect(70,60,150,100);
fill(0, 100, 0); 
...
//String words= getX + " " + getV;
//String[] list = split(words, ' ');
// Writes the strings to a file, each on a separate line
//saveStrings("position.txt",list);
